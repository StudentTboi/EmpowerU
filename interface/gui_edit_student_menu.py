...
class EditStudents(tk.Frame):
    ...
    def show_edit_student_info(self, student_to_edit):
        ...
        self.firstname_var = tk.StringVar(master=self, value=student_to_edit.first_name)
        ...
        self.lastname_var = tk.StringVar(master=self, value=student_to_edit.last_name)
        ...
        self.dob_var = tk.StringVar(master=self, value=student_to_edit.date_of_birth)
        ...
        self.contact_num_var = tk.StringVar(master=self, value=student_to_edit.contact_num)
        ...
        self.contact_email_var = tk.StringVar(master=self, value=student_to_edit.contact_email)
        ...
        self.username_var = tk.StringVar(master=self, value=student_to_edit.username)
        ...
        self.password_var = tk.StringVar(master=self, value=student_to_edit.password)
        ...
        # Button to login
        self.search_button = tk.Button(master=self, text="Edit", command= lambda: self.edit_student(student_to_edit))
