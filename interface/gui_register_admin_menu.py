...
class RegisterAdmins(tk.Frame):
    def __init__(self, master, administrator_menu, administrator_user):
        ...
        self.instrument_label = tk.Label(master=self, text="Register admin:")
        ...
        # Button to login
        self.search_button = tk.Button(master=self, text="Register", command=self.register_admin)
    ...
    def register_admin(self):
        ...
        elif self.administrator_user.store_admin_data(self.firstname_var.get(), self.lastname_var.get(), self.dob_var.get(), self.contact_num_var.get(), self.contact_email_var.get(), self.username_var.get(), self.password_var.get()):
