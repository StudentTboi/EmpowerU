...
class RegisterStudents(tk.Frame):
    def __init__(self, master, administrator_menu, administrator_user):
        ...
        self.instrument_label = tk.Label(master=self, text="Register student:")
        ...
        # Button to login
        self.search_button = tk.Button(master=self, text="Register", command=self.register_student)
    ...
    def register_student(self):
        ...
        elif self.administrator_user.store_student_data(self.firstname_var.get(), self.lastname_var.get(), self.dob_var.get(), self.contact_num_var.get(), self.contact_email_var.get(), self.username_var.get(), self.password_var.get()):
