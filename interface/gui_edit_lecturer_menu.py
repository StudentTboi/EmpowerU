...
class EditLecturers(tk.Frame):
    ...
    def show_edit_lecturer_info(self, lecturer_to_edit):
        ...
        self.firstname_var.set(lecturer_to_edit.first_name)
        self.lastname_var.set(lecturer_to_edit.last_name)
        self.dob_var.set(lecturer_to_edit.date_of_birth)
        self.contact_num_var.set(lecturer_to_edit.contact_num)
        self.contact_email_var.set(lecturer_to_edit.contact_email)
        self.username_var.set(lecturer_to_edit.username)
        self.password_var.set(lecturer_to_edit.password)
        
        # Button to login
        self.edit_button = tk.Button(master=self, text="Edit", command= lambda: self.edit_lecturer(lecturer_to_edit))
    ...
    def edit_lecturer(self, lecturer_to_edit):
        ...
        if not util.is_valid_first_name(self.firstname_var.get()):
            ...
            self.alert_var.set("Successfully edited lecturer information")
            self.firstname_entry.delete(0,"end")
